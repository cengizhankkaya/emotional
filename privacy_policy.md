...
*   **Bildirimler:** İndirme durumları veya önemli güncellemeler için.
*   **Depolama/Galeri:** Cihazınızdaki videoları seçebilmeniz ve indirilen dosyaları saklayabilmek için.
*   **Ekran Kaydı (Screen Share):** Odadaki diğer katılımcılarla ekranınızı paylaşabilmeniz için (sadece siz başlattığınızda aktiftir).
...
## 5. Hesabın Silinmesi ve Veri Talepleri
...
## 6. Çocuk Güvenliği ve CSAE Politikası

**Emoti** olarak, çocukların korunması bizim en önemli önceliklerimizden biridir. Uygulamamızda **Çocuk Cinsel İstismarı Materyallerinin (CSAE)** barındırılması, paylaşılması veya tanıtılması kesinlikle yasaktır.

Bu politika kapsamında:
*   **Sıfır Tolerans:** CSAE içeriğine karşı sıfır tolerans politikası uyguluyoruz.
*   **İzleme ve Bildirim:** Herhangi bir ihlal tespit edildiğinde, ilgili içerik derhal silinecek, kullanıcı hesabı kalıcı olarak askıya alınacak ve durum yasal mercilere bildirilecektir.
*   **Standartlar:** Standartlarımız Google Play'in Çocuk Güvenliği Standartları Politikası ile tam uyumludur.
*   **İletişim/Bildirim:** Herhangi bir uygunsuz içerik bildirmek veya bu politika ile ilgili soru sormak için lütfen bizimle iletişime geçin: 📧 **info.esceai@gmail.com**
